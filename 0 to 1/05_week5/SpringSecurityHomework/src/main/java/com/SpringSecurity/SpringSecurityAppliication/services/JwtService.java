...
public class JwtService {
             ...
             private SecretKey getSecretKey(){     // method to get the secret key by a method so this method can be use directly in signWith()
        ...
        public String createTokens(User user){
           ...
           return  Jwts.builder()
                   ...
                   .expiration(new Date(System.currentTimeMillis() + 1000*60))  // defining the expiry date of this token
